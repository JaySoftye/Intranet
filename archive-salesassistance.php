<?php
/**
 * The template for displaying archive pages of
 * CUSTOM POST TYPE Sales Assistance
 */
			...
			<div class="column small-6 medium-3">
				<div class="card <?php echo get_post_meta( $post->ID, 'location_type', true ); ?>">
  				<a href="<?php if(metadata_exists('post', $post->ID,'location')) { echo get_post_meta( $post->ID, 'location', true ); } else { the_permalink(); }; ?>">
						...
						<?php } else { ?>
							<img src="<?php echo get_template_directory_uri(); ?>/images/default-image.svg" alt="<?php the_title(); ?>" />
						<?php } ?>
					</a>
