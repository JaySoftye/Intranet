<?php
/*
Template Name: Sales Assistance Territories
*/
 ...
 <div class="container archive-content">
	 <div class="title row">
       ...
       <?php
          $args = array (
            ...
            'category_name' => 'ny-territories,nj-territories,pa-territories,ma-territories'
          );
          $the_query = new WP_Query( $args );
        ?>
			 <h1><strong>Sales Territories</strong></h1>
		 </div>
   ...
   <script type="text/javascript">
    $(document).ready(function(){
      $('button.button').click(function() {
        $(this).toggleClass('hollow').siblings().removeClass('hollow');
        var value = '.' + $(this).val();
          $('div.sales-post-territory').show().not(value).hide();
      });
    });
   </script>
   ...
   <div class="row archives">
     <div class="column small-12 medium-8">
       <p class="text-left">
         <button type="button" value="ma-territories" class="button small secondary" style="padding: 1rem 2rem;">Massachusetts Territories</button>
         <button type="button" value="ny-territories" class="button small secondary" style="padding: 1rem 2rem;">New York Territories</button>
         <button type="button" value="nj-territories" class="button small secondary" style="padding: 1rem 2rem;">New Jersey Territories</button>
         <button type="button" value="pa-territories" class="button small secondary" style="padding: 1rem 2rem;">Pennsylvania Territories</button>
       </p>
     </div>
   </div>
	 <div class="row archives">
    ...
    <div class="sales-post-territory column small-6 medium-3 <?php foreach((get_the_category()) as $category) { echo $category->slug . ' '; } ?>">
			<article>
