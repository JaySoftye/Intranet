<?php
/*
Template Name: Sales Assistance Sales Training
*/
   ...
   <div class="title row">
       ...
       <?php
          $args = array (
            ...
            'category_name' => 'sales-training'
          );
          $the_query = new WP_Query( $args );
        ?>
			 <h1><strong>Sales Training</strong></h1>
		 </div>
   ...
   <div class="row archives">
	 ...
	 <div class="row archives">
      ...
      ?>
            ...
            <small><strong><?php echo get_the_date(); ?></strong></small>
