<?php
/*
Template Name: Sales Assistance SPIF
*/
   ...
   <div class="title row">
       ...
       <?php
          $args = array (
            ...
            'category_name' => 'sales-spif'
          );
          $the_query = new WP_Query( $args );
        ?>
			 <h1><strong>Sales Performance Incentive Fund (SPIFS)</strong></h1>
		 </div>
   ...
   <div class="row archives">
	 ...
	 <div class="row archives">
      ...
      ?>
            ...
            <h6 class="alert-box-text">
              EXPIRES <br /><strong><?php echo get_post_meta( $post->ID, 'location_expire', true ); ?></strong>
            </h6>
            <?php } ?>
  				</div>
				</div>
